...
import com.dicoding.kulitku.api.Api
import com.dicoding.kulitku.api.ApiConfig
import com.dicoding.kulitku.api.NewsItem
import com.dicoding.kulitku.api.NewsResponse
...
class NewsRepository {
    fun getHealthNews(
        ...
        Api.newsApiService.searchHealthNews("cancer", "health", "en", ApiConfig.API_KEY)
